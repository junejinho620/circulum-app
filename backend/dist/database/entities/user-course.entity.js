...
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, (u) => u.userCourses, { onDelete: 'CASCADE' }),
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => course_entity_1.Course, (c) => c.userCourses, { onDelete: 'CASCADE' }),
...
exports.UserCourse = UserCourse = __decorate([
    ...
    (0, typeorm_1.Index)(['userId', 'courseId'], { unique: true })
], UserCourse);
